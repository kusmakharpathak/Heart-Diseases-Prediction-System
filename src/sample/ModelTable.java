...
public class ModelTable {
    ...
    public ModelTable(String id, String fName, String mName, String lName, String dateOfBirth, int age, String gender, String contact, String address, int cp, int trestbps, int chol, int fbs, int restecg, int thalach, int exang, Double oldpeak, int slop, int ca, int thal) {
        this.id = id;
        this.fName = fName;
        this.mName = mName;
        this.lName = lName;
